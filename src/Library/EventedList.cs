...
public class EventedList<T> : IList<T>, IList
{
    ...
    public T this [int index]
    {
        get
        {
            return index >= _size ? throw new ArgumentOutOfRangeException( nameof( index ) ) : _items [index];
        }
        set
        {
            if ( index >= _size )
    ...
    {
        return index > _size ? throw new ArgumentOutOfRangeException( nameof( index ) ) : Array.IndexOf( _items , item , index , _size - index );
    }
    ...
    {
        return index >= _size ? throw new ArgumentOutOfRangeException( nameof( index ) ) : LastIndexOf( item , index , index + 1 );
    }
    ...
    public struct Enumerator : IEnumerator<T>, IDisposable, IEnumerator
    {
        ...
        object IEnumerator.Current
        {
            get
            {
                return (index == 0) || (index == (list._size + 1)) ? throw new InvalidOperationException() : ( object )Current;
            }
        }
