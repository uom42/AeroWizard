...
namespace AeroWizard
{
    ...
    public class ThemedImageButton : ButtonBase
    {
        ...
        {
            //	System.Diagnostics.Debug.WriteLine ($"PaintButton: DesignMode:{this.IsDesignMode ()};vsEnabled:{Application.RenderWithVisualStyles};vsOnOS:{VisualStyleInformation.IsSupportedByOS};btnState:{ButtonState};enabled:{Enabled};imgCt:{( ImageList is not null ? ImageList.Images.Count : 0 )}");
