...
{
    private static readonly string[] propsToRemove = [
        "Anchor",
        "AutoScrollOffset",
        "AutoSize",
        "BackColor",
    ...
    internal class WizardPageDesignerActionList ( WizardPageDesigner pageDesigner , WizardPage page ) : RichDesignerActionList<WizardPageDesigner , WizardPage>( pageDesigner , page )
    {
...
internal class WizardPageDesignerBehavior ( WizardPageDesigner designer ) : RichBehavior<WizardPageDesigner>( designer )
{
