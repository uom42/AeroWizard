...
namespace AeroWizard
{
        ...
        , ISupportInitialize
    {
        ...
        private static readonly bool isWin6 = Environment.OSVersion.Version.Major >= 6;
        ...
        public WizardCommandButtonState CancelButtonState
            => pageContainer.CancelButtonState;
        ...
        {
            get => field;
            set { field = value; ConfigureStyles(); Invalidate(); }
        } = WizardClassicStyle.AeroStyle;
        ...
        private bool UseAeroStyle
            => ClassicStyle == WizardClassicStyle.AeroStyle
            || (ClassicStyle == WizardClassicStyle.Automatic && DesktopWindowManager.CompositionSupported && Application.RenderWithVisualStyles);
        ...
        protected virtual Bitmap GetUnthemedBackButtonImage ()
            => Environment.OSVersion.Version >= new Version( 6 , 2 ) ? Properties.Resources.BackBtnStrip2 : Properties.Resources.BackBtnStrip;
        ...
        protected virtual void OnCancelling ( CancelEventArgs arg )
        {
            ...
            if ( !arg.Cancel ) CloseForm( DialogResult.Cancel );
        }
        ...
        protected override void OnControlAdded ( ControlEventArgs e )
        {
            ...
            if ( e.Control is not WizardPage page ) return;
        ...
        protected override void OnParentChanged ( EventArgs e )
        {
            ...
            else if ( parentControl is UserControl oldParentAsUserControl )
        ...
        private Rectangle GetContentAreaRectangle ( bool parentRelative )
        {
            ...
            if ( parentRelative ) r.Offset( contentArea.Location );
            return r;
        }
        ...
        {
            if ( isWin6 && Application.RenderWithVisualStyles )
            {
        ...
        {
            if ( e.Button == MouseButtons.Left ) formMoveTracking = false;
            OnMouseUp( e );
        }
    }
}